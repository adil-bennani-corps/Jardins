  ...
  return (
    <div className="container-luxury section-padding">
      ...
      <section className="mt-8 text-center sm:mt-12 md:mt-14">
        ...
        <a
          href="https://www.google.com/search?sca_esv=643cd21dc826a565&sxsrf=ANbL-n5HBkkg8QM0MKfIllAi89dBo10KAA:1772295162269&si=AL3DRZEsmMGCryMMFSHJ3StBhOdZ2-6yYkXd_doETEE1OR-qOVSuxA3biRwxrgokC6sGCCvfQXD93Z-j_43dRqDAZYaqIGDstybgWmW_0ti4idMVvIPU7yFqeXa5NMTvY3MskTFO9phyWwj8dRDmk-z4_yuCMRI0RQ%3D%3D&q=Jardins+Moulron+SPRL+S+Reviews&sa=X&ved=2ahUKEwjB8dX8yfySAxV1TqQEHadNGbwQ0bkNegQIJxAF&biw=1536&bih=695&dpr=1.25"
          target="_blank"
      ...
      <section className="mt-12 rounded-2xl bg-primary-700 p-6 text-center text-white sm:mt-16 sm:rounded-3xl sm:p-8 md:mt-20 md:p-10">
        ...
        <div className="mt-6 flex flex-col gap-3 sm:mt-8 sm:flex-row sm:flex-wrap sm:justify-center sm:gap-4">
          ...
          <a
            href="https://wa.me/32475522156?text=Bonjour,%20je%20souhaite%20un%20devis."
            target="_blank"
            rel="noopener noreferrer"
